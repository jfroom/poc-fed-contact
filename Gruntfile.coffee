...
module.exports = (grunt)->
  ...
  grunt.initConfig
    ...
    copy:
      ...
      fontDist:
        files: [
          { expand: true, cwd: '<%= yeoman.app %>/components/font-awesome/fonts/', src: ['**'], dest: '<%= yeoman.dist %>/components/font-awesome/fonts/' }
          # {'<%= yeoman.dist %>': '<%= yeoman.app %>/components/font-awesome/fonts/*'}
        ]
